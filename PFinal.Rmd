...
Para ello haremos el test de Saphiro-Wilk que se usa para comprobar la normalidad de un conjunto de datos. En este caso, lo aplicaremos a cada variable.
...
### Validación del clasificador cuadrático
