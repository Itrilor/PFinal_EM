...
## *Validación de los clasificadores*
  Validación clasificador lineal
  
    ```{r echo=TRUE, include=TRUE, warning=FALSE}
nuevas_observaciones <- data.frame(ZESPVIDA=-1.2, ZPOBDENS=-0.5, ZPOBURB=-0.56, ZTMEDICO= -0.51, ZTMINFAN=0.52, ZPAGRICU=-0.04, ZPSERVI=0.24, ZTLIBROP=-0.14, ZTEJERCI=0.54, ZTPOBACT=0.33, ZTENERGI=-0.1)
...
trainig_error <- mean(datos_i$PAIS != pred$class) * 100
